<header class="bg-blue-900 text-white p-4" x-data="{open: false}">
    ...
    <!-- Mobile Menu -->
    <nav x-show="open" @click.away="open = false" {{-- @click.away means if we click outside the menu the menu disappears --}}
    id="mobile-menu" class="md:hidden bg-blue-900 text-white mt-5 pb-4 space-y-2">
