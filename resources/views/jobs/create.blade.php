<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="/jobs" enctype="multipart/form-data">
            ...
            <x-inputs.text id='requirements' name='requirements' label='Requirements' placeholder='Bachelor's degree in Computer Science' />
            <x-inputs.text id='benefits' name='benefits' label='Benefits' placeholder='Health insurance, 401k, paid time off' />           
            ...
            <x-inputs.text id='company_description' name='company_description' label='Company Description' placeholder=' Enter company description' />
